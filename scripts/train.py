...
def init_train_state(
    ...
    if config.load_checkpoint_path is not None:
        loader = _weight_loaders.CheckpointWeightLoader(params_path=config.load_checkpoint_path)
    partial_params = _load_weights_and_validate(loader, train_state_shape.params.to_pure_dict())
